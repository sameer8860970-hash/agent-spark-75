...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = [
      "You are a helpful AI assistant. You can use markdown formatting including:",
      ...
      "",
      "Keep answers clear, well-formatted, and concise.",
      knowledgeContext
        ? `\n\n## User Knowledge Context\nThe user has provided the following context. Use it to personalize your responses:\n\n${knowledgeContext}`
        : "",
    ].join("\n");
